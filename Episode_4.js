...
const Header= ()=>{
    return(<div className="header">
            <div className="logo-container">
                <img className="logo" src="https://img.freepik.com/premium-vector/food-delivery-logo-template-design_316488-538.jpg"/>
            </div>
...
const RestraurentCards = (props)=>{
    ...
    return(
        <div className="resto-cards">
            ...
            {/* <img  className="resto-img" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + restObj.data.cloudinaryImageId}/>
           
            <div className="resto-info">
            <p className="resto-title">{restObj.data.name}</p>
            <p><i class="fa-solid fa-star"></i>
            <span>{restObj.data.avgRating} •{(restObj.data.deliveryTime-5) + "-"+restObj.data.deliveryTime} mins </span></p>
            <p>{restObj.data.cuisines[0]+", "+restObj.data.cuisines[1]+",..."}</p>
            <p>{restObj.data.area}</p> */}

           <img  className="resto-img" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId}/>
        ...
        <div className="body">
            <div className="search">
                ...
                <div className="rest-container">
                    ...
                    {/* <RestraurentCards restObj = {restData[0]}/>
                    <RestraurentCards restObj = {restData[1]}/>
                    <RestraurentCards restObj = {restData[2]}/>
                    <RestraurentCards restObj = {restData[3]}/>
                    <RestraurentCards restObj = {restData[4]}/>
                    <RestraurentCards restObj = {restData[5]}/>
                    <RestraurentCards restObj = {restData[6]}/>
                    <RestraurentCards restObj = {restData[7]}/> */}
